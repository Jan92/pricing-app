...
export class LanguageService {
  ...
  private translations = {
    de: {
      ...
      // Example Score Names
      'examples.ctBefundung': 'CT-Befundung',
      'examples.befundungendokrinologie': 'Befundung Endokrinologie',
      'examples.befundunggerinnung': 'Befundung Gerinnung',
      'examples.befundungmikrobiologie': 'Befundung Mikrobiologie (Sepsisdiagnostik)',
      'examples.befundungkardiologie': 'Befundung Kardiologie (EKG-Analyse)',
      'examples.radiologischetumorbefundung': 'Radiologische Tumor-Befundung',
      'examples.genetischediagnostik': 'Genetische Diagnostik',
      'examples.neurologischebefundung': 'Neurologische Befundung',
      'examples.allergyDiagnostics': 'Allergie-Diagnostik',
      'examples.infectionDiagnostics': 'Infektions-Diagnostik (Covid-19 PCR)',
      'examples.genetischeDiagnostik': 'Genetische Diagnostik (z.B. Erbkrankheiten)',
      'examples.allergiediagnostik': 'Allergiediagnostik',
      'examples.infektionsdiagnostik': 'Infektionsdiagnostik (Covid-19-PCR)',
      'examples.neurologischeBefundung': 'Neurologische Befundung (z.B. Schlaganfall)',
      ...
      'criteria.diseaseRarityDesc': 'Häufigkeit des Auftretens in der Bevölkerung',
      'criteria.diagnosticAmbiguityDesc': 'Schwierigkeit bei der Diagnosestellung',
      'criteria.prognosticUncertaintyDesc': 'Unsicherheit bei der Prognose',
      'criteria.multimorbidityDesc': 'Grad der Begleiterkrankungen',
      'criteria.diseaseSeverityDesc': 'Schweregrad der Erkrankung',
      'criteria.differentialDepthDesc': 'Tiefe der Differenzialdiagnostik',
      'criteria.prognosticPrecisionDesc': 'Präzision der Prognose',
      'criteria.realtimeRequirementDesc': 'Anforderung an Echtzeitverarbeitung',
      'criteria.interdisciplinaryRelevanceDesc': 'Relevanz für verschiedene Fachbereiche',
      'criteria.dynamicAdaptabilityDesc': 'Anpassungsfähigkeit an sich ändernde Bedingungen',
      'criteria.automationLevelDesc': 'Grad der Automatisierung',
      'criteria.analysisLevelDesc': 'Tiefe der durchgeführten Analyse',
      'criteria.recommendationComplexityDesc': 'Komplexität der Empfehlungen',
      'criteria.guidelineIntegrationDesc': 'Integration von Leitlinien',
      'criteria.patientIndividualizationDesc': 'Individualisierung für den Patienten',
      ...
      'simulationHistory.lastResult': 'Letztes Simulationsergebnis',
      'simulationHistory.inputParameters': 'Eingabeparameter',
      'simulationHistory.calculatedAnnualCosts': 'Berechnete Jahreskosten',
      'simulationHistory.annualRentalCosts': 'Jahreskosten Miete:',
      'simulationHistory.annualVolumeBasedCosts': 'Jahreskosten Volumenbasiert:',
      'simulationHistory.annualAIScoreBasedCosts': 'Jahreskosten KI-Score-basiert:',
      'simulationHistory.exportResult': 'Ergebnis als Excel exportieren',
      'simulationHistory.calculation': 'Rechenweg:',
      'simulationHistory.users': 'Nutzer:',
      'simulationHistory.requestsPerMonth': 'Anfragen/Monat:',
      'simulationHistory.aiScore': 'KI-Score:',
      'simulationHistory.monthlyPricePerUser': 'Monatl. Preis/Nutzer:',
      'simulationHistory.pricePerRequest': 'Preis/Anfrage:',
      ...
      'pricing.implementation.customerRetention': 'Kundenbindung',
      'pricing.implementation.customerRetention.strong': 'Stark',
      'pricing.implementation.customerRetention.strongDesc': 'Hohe Wechselkosten, starke Bindung',
      'pricing.implementation.customerRetention.weak': 'Schwach',
      'pricing.implementation.customerRetention.weakDesc': 'Geringe Wechselkosten, schwache Bindung',
      'pricing.implementation.deploymentType': 'Bereitstellungsart',
      'pricing.implementation.deploymentType.cloud': 'Cloud',
      'pricing.implementation.deploymentType.onpremises': 'On-Premises',
      'pricing.implementation.salesChannel': 'Vertriebskanal',
      'pricing.implementation.salesChannel.direct': 'Direktvertrieb',
      'pricing.implementation.salesChannel.partner': 'Partnervertrieb',
      ...
      'pricing.businessModel.upgradePath': 'Upgrade-Pfad',
      'pricing.businessModel.upgradePath.tiered': 'Gestaffelt',
      'pricing.businessModel.upgradePath.tieredDesc': 'Verschiedene Produktstufen mit Upgrade-Möglichkeiten',
      'pricing.businessModel.upgradePath.flat': 'Flach',
      'pricing.businessModel.upgradePath.flatDesc': 'Einheitliches Produkt ohne Stufen',
      'pricing.businessModel.supportIntensity': 'Support-Intensität',
      'pricing.businessModel.supportIntensity.minimal': 'Minimal',
      'pricing.businessModel.supportIntensity.maximal': 'Maximal',
      'pricing.businessModel.supportIntensity.level1': 'Level 1 - Minimal',
      'pricing.businessModel.supportIntensity.level1Desc': 'Grundlegender Support, Selbstbedienung',
      'pricing.businessModel.supportIntensity.level2': 'Level 2 - Basis',
      'pricing.businessModel.supportIntensity.level2Desc': 'E-Mail Support, Dokumentation',
      'pricing.businessModel.supportIntensity.level3': 'Level 3 - Standard',
      'pricing.businessModel.supportIntensity.level3Desc': 'Telefon Support, Schulungen',
      'pricing.businessModel.supportIntensity.level4': 'Level 4 - Premium',
      'pricing.businessModel.supportIntensity.level4Desc': 'Dedizierter Support, 24/7 Verfügbarkeit',
      'pricing.businessModel.supportIntensity.level5': 'Level 5 - Maximal',
      'pricing.businessModel.supportIntensity.level5Desc': 'Vollständiger Support, persönlicher Ansprechpartner',
      'pricing.businessModel.pricingModel': 'Preismodell',
      'pricing.businessModel.pricingModel.fixed': 'Feste Lizenzgebühr',
      'pricing.businessModel.pricingModel.fixedDesc': 'Jährliche oder monatliche Pauschalgebühr',
      'pricing.businessModel.pricingModel.usage': 'Nutzungsbasiert',
      'pricing.businessModel.pricingModel.usageDesc': 'Preis pro Nutzung',
      'pricing.businessModel.pricingModel.hybrid': 'Hybrid-Modell',
      'pricing.businessModel.pricingModel.hybridDesc': 'Kombination aus Abonnement und Nutzung',
      'pricing.businessModel.hybridSubscription': 'Grundgebühr (jährlich)',
      'pricing.businessModel.hybridSubscriptionTooltip': 'Feste jährliche Grundgebühr',
      'pricing.businessModel.hybridUsageFee': 'Nutzungsgebühr pro Fall',
      'pricing.businessModel.hybridUsageFeeTooltip': 'Zusätzliche Gebühr pro Analyse',
      ...
      // Results Page
      'pricing.results.title': 'EMPFOHLENE PRICING-STRATEGIE',
      'pricing.results.systemCharacterization': 'SYSTEMCHARAKTERISIERUNG',
      'pricing.results.autonomyLevel': 'Autonomie-Level',
      'pricing.results.measurability': 'Messbarkeit',
      'pricing.results.inferenceCosts': 'Inferenzkosten',
      'pricing.results.complexityScore': 'Komplexitäts-Score',
      'pricing.results.primarySector': 'Primärer Sektor',
      'pricing.results.reimbursementIntegration': 'Erstattungsintegration',
      'pricing.results.salesComplexity': 'Sales Complexity',
      'pricing.results.deploymentType': 'Bereitstellungsart',
      'pricing.results.salesChannel': 'Vertriebskanal',
      'pricing.results.costCalculation': 'Cost Calculation',
      'pricing.results.costPerCase': 'Cost per Case',
      'pricing.results.profitMargin': 'Profit Margin',
      'pricing.results.recommendations': 'Recommendations',
      'pricing.results.recommendationsAndPricingModel': 'Recommendations & Pricing Model',
      'pricing.results.pricingModel': 'Pricing Model',
      'pricing.results.additionalMetrics': 'ZUSÄTZLICHE KENNZAHLEN',
      'pricing.results.yes': 'Ja',
      'pricing.results.no': 'Nein',
      'pricing.results.yesWithGOA': 'Ja (GOÄ/EBM)',
      'pricing.results.breakEvenPoint': 'Break-even-Punkt',
      'pricing.results.annualRevenue': 'Jährlicher Erlös',
      'pricing.results.partnerCommission': 'Partnerprovision',
      'pricing.results.perSale': 'pro Verkauf',
      'pricing.results.oneTime': 'einmalig',
      'pricing.results.cases': 'Fälle',
      'pricing.results.usages': 'Nutzungen',
      'pricing.results.approximately': 'ca.',
      'pricing.businessModel.recommendedPriceDACS': 'Empfohlener Preis (DACS)',
      ...
      'pricing.validation.validHybridBaseFee': 'Bitte geben Sie eine gültige Grundgebühr für das Hybrid-Modell ein',
      'pricing.validation.validHybridUsageFee': 'Bitte geben Sie eine gültige Nutzungsgebühr für das Hybrid-Modell ein',
      'pricing.validation.validDacsBasePrice': 'Bitte geben Sie einen gültigen Basispreis für das DACS-Modell ein',
    ...
    en: {
      ...
      // Example Score Names
      'examples.ctBefundung': 'CT Report',
      'examples.befundungendokrinologie': 'Endocrinology Report',
      'examples.befundunggerinnung': 'Coagulation Report',
      'examples.befundungmikrobiologie': 'Microbiology Report (Sepsis Diagnostics)',
      'examples.befundungkardiologie': 'Cardiology Report (ECG Analysis)',
      'examples.radiologischetumorbefundung': 'Radiological Tumor Report',
      'examples.genetischediagnostik': 'Genetic Diagnostics',
      'examples.neurologischebefundung': 'Neurological Report',
      'examples.allergyDiagnostics': 'Allergy Diagnostics',
      'examples.infectionDiagnostics': 'Infection Diagnostics (Covid-19 PCR)',
      'examples.genetischeDiagnostik': 'Genetic Diagnostics (e.g., Hereditary Diseases)',
      'examples.allergiediagnostik': 'Allergy Diagnostics',
      'examples.infektionsdiagnostik': 'Infection Diagnostics (Covid-19 PCR)',
      'examples.neurologischeBefundung': 'Neurological Report (e.g., Stroke)',
      ...
      'criteria.diseaseRarityDesc': 'Frequency of occurrence in the population',
      'criteria.diagnosticAmbiguityDesc': 'Difficulty in making a diagnosis',
      'criteria.prognosticUncertaintyDesc': 'Uncertainty in prognosis',
      'criteria.multimorbidityDesc': 'Degree of comorbidities',
      'criteria.diseaseSeverityDesc': 'Severity of the disease',
      'criteria.differentialDepthDesc': 'Depth of differential diagnosis',
      'criteria.prognosticPrecisionDesc': 'Precision of prognosis',
      'criteria.realtimeRequirementDesc': 'Requirement for real-time processing',
      'criteria.interdisciplinaryRelevanceDesc': 'Relevance for different specialties',
      'criteria.dynamicAdaptabilityDesc': 'Adaptability to changing conditions',
      'criteria.automationLevelDesc': 'Degree of automation',
      'criteria.analysisLevelDesc': 'Depth of the performed analysis',
      'criteria.recommendationComplexityDesc': 'Complexity of recommendations',
      'criteria.guidelineIntegrationDesc': 'Integration of guidelines',
      'criteria.patientIndividualizationDesc': 'Individualization for the patient',
      ...
      'pricing.implementation.customerRetention': 'Customer Retention',
      'pricing.implementation.customerRetention.strong': 'Strong',
      'pricing.implementation.customerRetention.strongDesc': 'High switching costs, strong retention',
      'pricing.implementation.customerRetention.weak': 'Weak',
      'pricing.implementation.customerRetention.weakDesc': 'Low switching costs, weak retention',
      'pricing.implementation.deploymentType': 'Deployment Type',
      'pricing.implementation.deploymentType.cloud': 'Cloud',
      'pricing.implementation.deploymentType.onpremises': 'On-Premises',
      'pricing.implementation.salesChannel': 'Sales Channel',
      'pricing.implementation.salesChannel.direct': 'Direct Sales',
      'pricing.implementation.salesChannel.partner': 'Partner Sales',
      
      // Pricing Strategy - Business Model Phase
      'pricing.businessModel.title': 'Business Model',
      'pricing.businessModel.subtitle': 'Selection of the appropriate business model',
      'pricing.businessModel.upgradePath': 'Upgrade Path',
      'pricing.businessModel.upgradePath.tiered': 'Tiered',
      'pricing.businessModel.upgradePath.tieredDesc': 'Different product levels with upgrade options',
      'pricing.businessModel.upgradePath.flat': 'Flat',
      'pricing.businessModel.upgradePath.flatDesc': 'Uniform product without tiers',
      'pricing.businessModel.supportIntensity': 'Support Intensity',
      'pricing.businessModel.supportIntensity.minimal': 'Minimal',
      'pricing.businessModel.supportIntensity.maximal': 'Maximal',
      'pricing.businessModel.supportIntensity.level1': 'Level 1 - Minimal',
      'pricing.businessModel.supportIntensity.level1Desc': 'Basic support, self-service',
      'pricing.businessModel.supportIntensity.level2': 'Level 2 - Base',
      'pricing.businessModel.supportIntensity.level2Desc': 'Email support, documentation',
      'pricing.businessModel.supportIntensity.level3': 'Level 3 - Standard',
      'pricing.businessModel.supportIntensity.level3Desc': 'Phone support, training',
      'pricing.businessModel.supportIntensity.level4': 'Level 4 - Premium',
      'pricing.businessModel.supportIntensity.level4Desc': 'Dedicated support, 24/7 availability',
      'pricing.businessModel.supportIntensity.level5': 'Level 5 - Maximal',
      'pricing.businessModel.supportIntensity.level5Desc': 'Full support, personal contact',
      'pricing.businessModel.pricingModel': 'Pricing Model',
      'pricing.businessModel.pricingModel.fixed': 'Fixed License Fee',
      'pricing.businessModel.pricingModel.fixedDesc': 'Annual or monthly flat fee',
      'pricing.businessModel.pricingModel.usage': 'Usage-based',
      'pricing.businessModel.pricingModel.usageDesc': 'Price per usage',
      'pricing.businessModel.pricingModel.hybrid': 'Hybrid Model',
      'pricing.businessModel.pricingModel.hybridDesc': 'Combination of subscription and usage',
      'pricing.businessModel.hybridSubscription': 'Base Fee (annually)',
      'pricing.businessModel.hybridSubscriptionTooltip': 'Fixed annual base fee',
      'pricing.businessModel.hybridUsageFee': 'Usage Fee per Case',
      'pricing.businessModel.hybridUsageFeeTooltip': 'Additional fee per analysis',
      ...
      // Results Page
      'pricing.results.title': 'RECOMMENDED PRICING STRATEGY',
      'pricing.results.systemCharacterization': 'SYSTEM CHARACTERIZATION',
      'pricing.results.autonomyLevel': 'Autonomy Level',
      'pricing.results.measurability': 'Measurability',
      'pricing.results.inferenceCosts': 'Inference Costs',
      'pricing.results.complexityScore': 'Complexity Score',
      'pricing.results.primarySector': 'Primary Sector',
      'pricing.results.reimbursementIntegration': 'Reimbursement Integration',
      'pricing.results.salesComplexity': 'Sales Complexity',
      'pricing.results.deploymentType': 'Deployment Type',
      'pricing.results.salesChannel': 'Sales Channel',
      'pricing.results.costCalculation': 'Cost Calculation',
      'pricing.results.costPerCase': 'Cost per Case',
      'pricing.results.profitMargin': 'Profit Margin',
      'pricing.results.recommendations': 'Recommendations',
      'pricing.results.recommendationsAndPricingModel': 'Recommendations & Pricing Model',
      'pricing.results.pricingModel': 'Pricing Model',
      'pricing.results.additionalMetrics': 'ADDITIONAL METRICS',
      'pricing.results.yes': 'Yes',
      'pricing.results.no': 'No',
      'pricing.results.yesWithGOA': 'Yes (GOÄ/EBM)',
      'pricing.results.breakEvenPoint': 'Break-even Point',
      'pricing.results.annualRevenue': 'Annual Revenue',
      'pricing.results.partnerCommission': 'Partner Commission',
      'pricing.results.perSale': 'per Sale',
      'pricing.results.oneTime': 'one-time',
      'pricing.results.cases': 'Cases',
      'pricing.results.usages': 'Usages',
      'pricing.results.approximately': 'approx.',
      'pricing.businessModel.recommendedPriceDACS': 'Recommended Price (DACS)',
      ...
      'pricing.validation.validHybridBaseFee': 'Please enter a valid base fee for the hybrid model',
      'pricing.validation.validHybridUsageFee': 'Please enter a valid usage fee for the hybrid model',
      'pricing.validation.validDacsBasePrice': 'Please enter a valid base price for the DACS model',
      ...
      'simulationHistory.lastResult': 'Last Simulation Result',
      'simulationHistory.inputParameters': 'Input Parameters',
      'simulationHistory.calculatedAnnualCosts': 'Calculated Annual Costs',
      'simulationHistory.annualRentalCosts': 'Annual Rental Costs:',
      'simulationHistory.annualVolumeBasedCosts': 'Annual Volume-based Costs:',
      'simulationHistory.annualAIScoreBasedCosts': 'Annual AI-Score-based Costs:',
      'simulationHistory.exportResult': 'Export Result as Excel',
      'simulationHistory.calculation': 'Calculation:',
      'simulationHistory.users': 'Users:',
      'simulationHistory.requestsPerMonth': 'Requests/Month:',
      'simulationHistory.aiScore': 'AI-Score:',
      'simulationHistory.monthlyPricePerUser': 'Monthly Price/User:',
      'simulationHistory.pricePerRequest': 'Price/Request:',
